...
<div class="md-card">
    <div class="md-card-content">
        <h3 class="heading_a" style="margin-bottom: 10px;">Страницы / Изменение</h3>
        @if(count($rows['page']))
            <form action="{{route('page.update',$rows['page']->id)}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            {{method_field('PUT')}}
                ...
                <div class="uk-width-medium-10-10">
                    <div class="uk-form-row">
                        <div class="md-input-wrapper md-input-filled">
                            ...
                            <input type="text" id="title" name="title" class="md-input" value="{{$rows['page']->title}}"><span class="md-input-bar"></span>
                        </div>
                    </div>
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper md-input-filled ">
                           <div class="uk-form-row">
                                ...
                                <textarea cols="30" rows="20" id="desc"  name="desc" class="md-input my-editor">{{$rows['page']->desc}}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="uk-form-row">
                        <div class="md-input-wrapper md-input-filled">
                            ...
                            <input type="number" id="sorting" name="sorting" class="md-input" value="{{$rows['page']->sorting}}"><span class="md-input-bar"></span>
                        </div>
                    </div>
                    ...
                    <div class="uk-width-medium-10-10" style="margin: 20px 0;">
                        <input type="checkbox" name="status" data-switchery {{$rows['page']->status == 1 ? 'checked' : ''}}    id="status" />
