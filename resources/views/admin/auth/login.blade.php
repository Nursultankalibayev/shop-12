...
<head>
    ...
    <!-- uikit -->
    <link rel="stylesheet" href="/system/bower_components/uikit/css/uikit.almost-flat.min.css"/>

    <!-- altair admin login page -->
    <link rel="stylesheet" href="/system/assets/css/login_page.min.css" />
...
<body class="login_page">
    ...
    <div class="login_page_wrapper">
            ...
            <div class="md-card-content large-padding" id="login_form">
                ...
                <form action="{{route('postLogin')}}" method="post">
                    ...
                    <div class="uk-form-row">
                        ...
                        <input class="md-input" type="text" id="email" name="email" value="{{isset($login) ? $login : ''}}" />
                    </div>
                    <div class="uk-form-row">
                        ...
                        @if(isset($error))
                            <div class="parsley-errors-list filled">
                                <span class="parsley-required" style="color: red;">{{$error}}</span>
                            </div>
                        @endif
                    </div>
                    <div class="uk-margin-medium-top">
                        <button class="md-btn md-btn-primary md-btn-block md-btn-large" type="submit">Войти</button>
                    </div>
                </form>
            </div>
        ...
        <div class="uk-margin-top">
            <a href="#" id="login_help_show">Забыл пароль?</a>
        </div>
    </div>

    <!-- common functions -->
    <script src="/system/assets/js/common.min.js"></script>
    <!-- altair core functions -->
    <script src="/system/assets/js/altair_admin_common.min.js"></script>
    <!-- altair login page functions -->
    <script src="/system/assets/js/pages/login_page.min.js"></script>
</body>
</html>